            ...
            >
              <form onSubmit={handleSearch}>
                <input
                  ...
                  className="w-62.5 h-10 rounded-full border border-[#6FA073] pl-4 pr-12 text-sm outline-none focus:ring-2 focus:ring-[#6FA073] focus:ring-opacity-50 transition-all placeholder:text-gray-400"
                />
                <button
                  type="submit"
                  className="absolute right-0 top-1/2 -translate-y-1/2 h-10 w-10 rounded-full bg-[#6FA073] flex items-center justify-center hover:bg-[#5d8f61] transition-colors"
                >
                            ...
                            <SheetClose asChild>
                              ...
                              >
                                ...
                                <ChevronRight
                                  size={18}
                                  className={
                                    link.active ? "text-[#6FA073]" : "text-gray-400"
                                  }
                                />
                              </Link>
                            </SheetClose>
                        ...
                        <div className="relative">
                          <form onSubmit={handleSearch}>
                            <input
                              ...
                              value={searchQuery}
                              onChange={(e) => setSearchQuery(e.target.value)}
                              className="w-full h-11 rounded-full border border-[#6FA073] pl-4 pr-12 text-sm outline-none focus:ring-2 focus:ring-[#6FA073] focus:ring-opacity-50 transition-all"
                            />
                            <button
                              type="submit"
                              className="absolute right-0 top-1/2 -translate-y-1/2 h-11 w-11 rounded-full bg-[#6FA073] flex items-center justify-center hover:bg-[#5d8f61] transition-colors"
                              aria-label="Search"
                            >
