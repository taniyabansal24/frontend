...
export default function CTASection() {
  return (
    <section className="py-24">
      <Container>
        <div className="max-w-[900px] mx-auto bg-white rounded-[36px] border border-[#ECECEC] shadow-[0_20px_60px_rgba(0,0,0,0.06)] px-8 md:px-16 py-16 text-center">
          {/* Heading */}
          ...
          {/* Description */}
          <p className="text-body-homepage text-[#5B6070] mt-6 max-w-[650px] mx-auto">
          ...
          <div className="mt-12">
            <a
              ...
              className="inline-flex items-center justify-center px-10 md:px-14 h-15 rounded-full bg-[#6FA073] text-white shadow-[0_12px_24px_rgba(111,160,115,0.25)] hover:shadow-[0_16px_32px_rgba(111,160,115,0.35)] hover:-translate-y-0.5 transition-all duration-300"
            >
